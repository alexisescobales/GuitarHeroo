...
function moverFlechas() {
    ...
    setInterval(function () {
        ...
        arrow_up = document.querySelectorAll("div.aup");
        arrow_down = document.querySelectorAll("div.adown");
        arrow_right = document.querySelectorAll("div.aright");
...
document.addEventListener('keydown', (event) => {
   ...
   // let prueba = document.querySelectorAll(".aleft");
   // let miflecha = document.getElementById("1");
    //LEFT
